...
Set.prototype.addMigration = function(title, up, down, seedFile) {
    this.migrations.push(new Migration(title, up, down, seedFile));
};
...
Set.prototype._migrate = function(direction, migrationName, fn) {
    ...
    function next(migration) {
        ...
        self.emit('migration', migration, direction, migration['seedFile'] || null);
